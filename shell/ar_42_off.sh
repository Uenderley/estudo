...
curl -i -s -k  -X 'POST' \
  ...
  --data-binary $'<?xml version=\"1.0\" encoding=\"UTF-8\"?>\x0d\x0a<Packet>\x0d\x0a <Command>setRequest</Command>\x0d\x0a <DatabaseManager>\x0d\x0a  <Mnet Group=\"42\" Drive=\"OFF\" SetTemp=\"25.0\" AirDirection=\"SWING\" FanSpeed=\"HIGH\" />\x0d\x0a </DatabaseManager>\x0d\x0a</Packet>\x0d\x0a' \
