...
public class RabbitMQConfig {
    ...
    @Bean
    Exchange myExchange(){
        return ExchangeBuilder.topicExchange("myTopicExchange").autoDelete().durable(true).build();
    }
    ...
    ConnectionFactory connectionFactory() {
        ...
        cachingConnectionFactory.setUsername("pc");
        cachingConnectionFactory.setPassword("pc");
